...
#   global flood_join
#   incr flood_join 1
#   utimer 5 "incr flood_join -1"
#   if {$flood_join > 5} {
#     if {[botisop $chan]} { putserv "MODE $chan +i" }
#     utimer 30 "putserv MODE $chan -i"
#     return 0
#   }
#		if {$lastmax} { puthelp "PRIVMSG $chan :New channel peak! (\002$curnum\002)  Last peak was [timeago [lindex $peak 1]] ago." }
bind join - * join:peak
